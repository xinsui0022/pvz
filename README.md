...
当前大版本：**v2.0.0**。本版包含阳光奖励修复、低血量权重、多个僵王分别显示，以及蹦极交替价格和矿工后方保护。详见 [第二个大版本说明](docs/v2.0.0.md)。
...
低血量权重改为满血 65%、半血 25%、三分之一 4%、四分之一 3%、五分之一 3%。适用于随机生成的普通、旗帜、报纸、铁栅门、伴舞、普通鸭子救生圈、潜水、海豚、气球、矿工、跳跳和小鬼；其他种类保留原来的血量随机规则。
